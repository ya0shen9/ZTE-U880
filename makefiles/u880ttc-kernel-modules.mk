...
#$(KERNEL_TOOLCHAIN_PREFIX)strip --strip-unneeded root/g_ether.ko && \
	...
	$(hide)cp kernel/System.map $(OUTDIR)/
	$(hide)cp kernel/vmlinux $(OUTDIR)/
...
telephony:
	...
	$(hide)cp $(TELEPHONY)/cp/tavor_p_ulc_u880/Arbel* $(OUTDIR)/telephony/
	$(hide)cp $(TELEPHONY)/cp/tavor_p_ulc_u880/TT* $(OUTDIR)/telephony/
